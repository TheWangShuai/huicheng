...
public class EmsHandler {
    ...
    public static EMSAlarmReportO alarmReportToEms(String evtNo,String alarmCode, String alarmMessage,String lotNo,String alarmTab){
        ...
        if(!StringUtils.hasText(outTrxStr)){
            ...
            emsAlarmReportO.setRtnMesg("[EAP-MES]:EAP发送设备报警，EMS没有回复");
    ...
    public static EMSStatusReportO emsStatusReportToEms(String evtNo,String eqpCommStatus,String lastState,String lastStateVal){
        ...
        if(!StringUtils.hasText(outTrxStr)){
            ...
            emsStatusReportO.setRtnMesg("[EAP-MES]:EAP发送设备报警，EMS没有回复");
    ...
    public static EMSLotInfoReportO emsLotInfoReporToEms(String evtNo ,EMSLotInfoReportI emsLotInfoReportI){
        ...
        if(!StringUtils.hasText(outTrxStr)){
            ...
            emsLotInfoReportO.setRtnMesg("[EAP-MES]:EAP发送设备报警，EMS没有回复");
    ...
    public static EMSDeviceParameterReportO emsDeviceParameterReportToEms(String evtNo, String lotNo,EMSDeviceParameterReportI emsDeviceParameterReportI ){
        ...
        if(!StringUtils.hasText(outTrxStr)){
            ...
            emsDeviceParameterReportO.setRtnMesg("[EAP-MES]:EAP发送设备报警，EMS没有回复");
    ...
    public static EMSGetAlarmO getAlarmFromEms(String evtNo,String alarmCode){
        ...
        if(!StringUtils.hasText(outTrxStr)){
            ...
            emsGetAlarmO.setRtnMesg("[EAP-MES]:EAP发送设备报警，EMS没有回复");
    ...
    // EAP上传生产Wafer信息
    public static EMSWaferReportO waferInfotoEms(String evtNo,EMSWaferReportI emsWaferReportI){
        ...
        if(!StringUtils.hasText(outTrxStr)){
           ...
           emsWaferReportO.setRtnMesg("[EAP-MES]:EAP发送设备报警，EMS没有回复");
    ...
    public static EMSGetTestResultO getTestResult(String evtNo,String deviceName){
        ...
        if(!StringUtils.hasText(outTrxStr)){
            ...
            emsGetTestResultO.setRtnMesg("[EAP-MES]:EAP发送设备报警，EMS没有回复");
